...
//        Collections.sort(options, new BusJourney());
    ...
    public static void buildGraph(JourneyPlanner planner)
    {
        ...
        while(departTime.compareTo(LocalTime.of(22,0)) <= 0)
        {
            BusTrip t1 = new BusTrip("23M", "Mt Albert", departTime, "New Lynn", arriveTime, BusTrip.TWO_STAGE);
            planner.add(t1);
            departTime = departTime.plusMinutes(30);
            arriveTime = arriveTime.plusMinutes(30);
            t1 = new BusTrip("23M", "Mt Albert", departTime, "New Lynn", arriveTime, BusTrip.TWO_STAGE);
            planner.add(t1);
            departTime = departTime.plusMinutes(30);
            arriveTime = arriveTime.plusMinutes(30);
        }
